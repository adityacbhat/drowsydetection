...
if __name__ == "__main__":
    ...
    drowsy_ear = compute_drowsy_ear(spectacles=False) # Normal EAR relative to the driver's posture, eye shape and eye spectacles detection
    set_thresholds(eye_aspect_ratio = drowsy_ear, frame_threshold = 10) # Greater EAR or lesser frame threshold = Greater sensitivity
